...
import { createCategoryAction,reset } from "../../redux/slices/category/categorySlice";
...
const AddNewCategory = () => {
  ...
  const { loading, appErr, serverErr,success, category } = state;
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            <p className="font-medium text-rose-700 hover:text-rose-900">
            ...
            <div>
              ...
              {loading ? (
                ...
                >
                  <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                    <PlusCircleIcon
                      className="h-5 w-5 text-white group-hover:text-emarald-400"
                      aria-hidden="true"
                    />
                  </span>
                  ADD NEW CATEGORY
